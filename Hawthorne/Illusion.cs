...
namespace Hawthorne
{
    ...
    {
        public static string ID = "Illusion";
        public static void Add(int entity)
        {
            ...
            {
                Passi.FakeGutted, Passives.Skittish, Passi.Illusion, Passives.Formless
            };
            enemy.enterEffects = new Effect[] { new Effect(ScriptableObject.CreateInstance<ShadowEnterEffect>(), 1, null, Slots.Self) };
            enemy.abilities = new Ability[] { Abili.Drain, Abili.Gnaw, Abili.SwapSupport };
            enemy.enemyID = "Illusion_EN";
            enemy.AddEnemy();
        }
    }
}
